...
#ifndef NAV2_BT_NAVIGATOR__NAVIGATORS__CLEAN_RACK_HPP_
#define NAV2_BT_NAVIGATOR__NAVIGATORS__CLEAN_RACK_HPP_
...
public:
  ...
  /**
   * @brief A constructor for CleanRackNavigator
   */
  CleanRackNavigator()
  : Navigator() {}
   ...
   */
  std::string getName() {return std::string("clean_rack");}
