...
#ifndef NAV2_BT_NAVIGATOR__NAVIGATORS__GO_ZIGZAG_HPP_
#define NAV2_BT_NAVIGATOR__NAVIGATORS__GO_ZIGZAG_HPP_
...
#include "nav2_msgs/action/zigzag.hpp"
 ...
 */
class GoZigZag
  : public nav2_bt_navigator::Navigator<nav2_msgs::action::Zigzag>
{
public:
  using ActionT = nav2_msgs::action::Zigzag;
   ...
   */
  std::string getName() {return std::string("go_zigzag");}
